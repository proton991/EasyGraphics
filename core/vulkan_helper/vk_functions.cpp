...
void VulkanFunction::InitInstanceFuncs(VkInstance instance) {
  ...
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceFormatProperties, "vkGetPhysicalDeviceFormatProperties");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceImageFormatProperties, "vkGetPhysicalDeviceImageFormatProperties");
  ...
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceQueueFamilyProperties, "vkGetPhysicalDeviceQueueFamilyProperties");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceQueueFamilyProperties2, "vkGetPhysicalDeviceQueueFamilyProperties2");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceMemoryProperties, "vkGetPhysicalDeviceMemoryProperties");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceFormatProperties2, "vkGetPhysicalDeviceFormatProperties2");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceMemoryProperties2, "vkGetPhysicalDeviceMemoryProperties2");

  GetInstanceProcAddr(fp_vkGetDeviceProcAddr, "vkGetDeviceProcAddr");
  GetInstanceProcAddr(fp_vkCreateDevice, "vkCreateDevice");
  GetInstanceProcAddr(fp_vkEnumerateDeviceExtensionProperties, "vkEnumerateDeviceExtensionProperties");

  GetInstanceProcAddr(fp_vkDestroySurfaceKHR, "vkDestroySurfaceKHR");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceSurfaceSupportKHR, "vkGetPhysicalDeviceSurfaceSupportKHR");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceSurfaceFormatsKHR, "vkGetPhysicalDeviceSurfaceFormatsKHR");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceSurfacePresentModesKHR, "vkGetPhysicalDeviceSurfacePresentModesKHR");
  GetInstanceProcAddr(fp_vkGetPhysicalDeviceSurfaceCapabilitiesKHR, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
}
